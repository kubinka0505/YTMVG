...
Config = {
	"Shell": {
		"01_Make_VideoAndThumbnail_01": ["Make Video and Thumbnail", "WMPLoc.dll,-1050", path.join(__EXT_SUBKEY, __CMD_VDTHB)],
		"02_Make_Video_02": ["Make Video", "WMPLoc.dll,-503", path.join(__EXT_SUBKEY, __CMD_VIDEO)],
		"03_Make_Thumbnail_03": ["Make Thumbnail", "WMPhoto.dll,-400", path.join(__EXT_SUBKEY, __CMD_THUMB)],
		"04_SEP_01": [],
		# Shell32.dll,-22
		# ImageRes.dll,-5334
		"05_Open_MainDirectory_01": ["Open YTMVG Main Directory", "Explorer.exe", "", fr'explorer.exe "{Main_File_Directory}"'],
		# ImageRes.dll,-1005
		"06_Open_VideoDirectory_01": ["Open YTMVG Videos Directory", "WMPLoc.dll,-29557", "", r'explorer.exe "{0}"'.format(os.path.join(Main_File_Directory, "Videos"))],
	},
	__CMD_KEY: {
		__CMD_VDTHB: {
